...
export default function Footer() {
  return (
    <footer className="bg-background">
      <div className="mx-auto px-4 md:px-6 py-16 sm:px-6 lg:px-8">
          ...
          <div className="col-span-2">
            <div>
              ...
              <p className="mt-4 text-foreground">
                Martizo is your trusted shopping destination, offering
                high-quality products at affordable prices. We are committed to
                providing a smooth shopping experience, fast delivery, secure
                payments, and top-notch customer support.
              </p>
            </div>
          </div>
