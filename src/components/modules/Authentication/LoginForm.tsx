        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <FieldGroup className="p-6 md:p-8">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="mithunmodakdu@gmail.com"
                          type="email"
                          {...field}
                        />
                      </FormControl>
            ...
            <Field className="grid grid-cols-3 gap-4">
              ...
              <Button className="cursor-pointer" variant="outline" type="button" onClick={() => window.open(`${config.baseUrl}/auth/google`)}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path
