  ...
  return (
    <Card className="border-border/60 shadow-sm flex flex-col">
          <CardHeader className="pt-5 pb-2 px-5">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">Revenue target — May 2026</p>
          </CardHeader>
            ...
            <div>
              ...
              <div className="mt-3 space-y-1.5">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="text-muted-foreground">${(remaining / 1000).toFixed(1)}k to go</span>
                </div>
                  ...
                  <div key={g.label} className="space-y-1">
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="font-medium text-foreground">
                        {g.unit}{g.current}
                        <span className="text-muted-foreground font-normal"> / {g.unit}{g.target}</span>
                      </span>
                    </div>
